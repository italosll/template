    ...
    >
{
  ...
  async findAll(params: {
    ...
    const queryBuilder =
      this._serviceOrderRepository.createQueryBuilder("serviceOrder");
  ...
  async lookup(params: {
    ...
    const queryBuilder = this._serviceOrderRepository
  ...
  async update(
    ...
    const registeredServiceOrder = await this._serviceOrderRepository.findOneBy(
      {
