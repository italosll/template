...
export type SchemeInputsContract<T = any> = SchemeInput<T> | SchemeSelect<T> | SchemeAutoComplete<T>
...
export type SchemeContract<T = any> = (SchemeDefaultContract<T> | SchemeArrayContract<T> | SchemeFormGroupContract<T>)[]