...
import { ChangeDetectionStrategy, Component, inject, Injector, input, runInInjectionContext } from "@angular/core";
...
@Component({
    ...
    template: `
      ...
      <tr mat-row *matRowDef="let row; columns: displayedColumns;" (click)="openUpdateDialog(row.id)"></tr>
    </table>
    `
})
