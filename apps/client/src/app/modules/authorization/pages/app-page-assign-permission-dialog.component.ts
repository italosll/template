...
import { AssignPermissionModel } from "../models/app-assign-permission.model";

@Component({
  selector: "app-page-assign-permission-dialog",
  ...
  template: `
    @if (formModel.ready()) {
      ...
      <h2 mat-dialog-title>Atribuir permissao</h2>
...
export class DialogAssignPermissionComponent {
  private readonly _http = inject(AuthorizationHttpService);
  private readonly _dialogRef = inject(MatDialogRef);

  protected formModel = new AssignPermissionModel();
